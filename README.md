...
```
## Опции
Опция           | Описание | Стандартное значение
:------------:|:--------:|:-------------------:
...
'patterns' => ['pattern'] | само регулярное выражение |
'patterns' => ['exclude'] | подстроки, которые нужно исключить из обработки после нахождения строки по регулярному выражению, например, кавычки |
